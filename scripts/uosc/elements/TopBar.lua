...
function TopBar:init()
	...
	self.buttons = {
		...
		-- TopBarButton:new('tb_max', {icon = 'crop_square', background = '55FFFFFF', command = decide_maximized_command}),
		TopBarButton:new('tb_min', {icon = 'minimize', background = '333333', command = 'cycle window-minimized'}),
	}
end
